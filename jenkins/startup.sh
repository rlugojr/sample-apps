...
java -jar /root/.jenkins/war/WEB-INF/jenkins-cli.jar -s http://127.0.0.1:8080/ install-plugin swarm github workflow-aggregator workflow-job workflow-basic-steps
